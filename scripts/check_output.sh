...
if grep -r --include=\*.php --exclude=class-pclzip.php --exclude=canonical.php --exclude=class-IXR-server.php --exclude=bootstrap.php --extended-regexp "(^|\ )die\(('|\")" ; then exit 1
fi
